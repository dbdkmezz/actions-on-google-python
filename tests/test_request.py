...
from libs.google_actions import GoogleRequest, NoJsonException
...
class TestRequest(unittest.TestCase):
    def test_parsing_fundamentals(self):
        ...
        request = GoogleRequest(MockRequest(body=body))
    ...
    def test_raises_no_json_exception(self):
        with self.assertRaises(NoJsonException):
            GoogleRequest(MockRequest(body='NOT JSON'))
    ...
    def test_text_none_if_no_arguments(self):
        ...
        result = GoogleRequest(MockRequest(body=body))
